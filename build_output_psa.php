...
$root_url = 'sample/n';
    ...
    $book_folder = 'sample/n' . str_pad(18, 2, '0', STR_PAD_LEFT) . '-' . 'psa';
    //
    // SCRAP CHAPTER
    //
    for ($chp = 1; $chp <= 150; $chp++) { 
        ...
        // print_r($verses);exit;
        write_chapter(str_pad(18,2,'0',STR_PAD_LEFT).'psa', str_pad($chp, 3, '0', STR_PAD_LEFT), $verses);
